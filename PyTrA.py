...
from traits.api import  HasTraits, File, Button, Array, Instance, Str, Int, Float
...
class MainWindow(HasTraits):
	...
	plotwaveindex = Float(0)
	plottimeindexshow = Float(0)
	plottimeindex = Float(0)
	...
	plot_group = Group(
		...
		(HSplit(Item('plotwaveindex', show_label=False),Item('plotwaveindexshow', show_label=False, style='readonly'),Item('Kinetic_Trace', show_label=False),Item('Fit_Trace', show_label=False),Item('mcmc',show_label=False),Item('DeleteTraces_1', show_label=False)))),
		(Item('plotwavelength', editor=ComponentEditor(), show_label=False),
		(HSplit(Item('plottimeindex', show_label=False),Item('plottimeindexshow', show_label=False, style='readonly'),Item('Spectra', show_label=False),Item('Fit_Spec', show_label=False),Item('DeleteSpectra_1', show_label=False))))
		),
		),
		label='2D plot'
	)
